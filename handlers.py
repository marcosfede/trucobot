...
class MessageHandler:
    ...
    async def pedirJugada(self, message):
        self.bot.jugada_enemiga(message["jugadaAnterior"])
    ...
    async def resultadoPartida(self, message):
        self.bot.resultado_partida(mensaje["ganada"])

    async def resultadoEnvido(self, message):
        self.bot.resultado_envido(mensaje["ganado"], mensaje["tantosOponente"])
